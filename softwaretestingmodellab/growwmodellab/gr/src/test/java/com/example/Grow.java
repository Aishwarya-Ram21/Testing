...
public class Grow {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\DELL\\Desktop\\growwmodellab\\report1.html");
    ...
    public void test1() throws Exception{
        ...
        FileInputStream fs = new FileInputStream("C:\\Users\\DELL\\Desktop\\growwmodellab\\gr.xlsx");
        ...
        Thread.sleep(3000);
String calc = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/h1")).getText();
Assert.assertTrue(calc.contains("Calculators"));
        File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String path = "C:\\Users\\DELL\\Desktop\\growwmodellab\\calc.png";
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            String path = "C:\\Users\\DELL\\Desktop\\growwmodellab\\"+result.getName()+".png";
            FileUtils.copyFile(screenshot,new File(path));
            test.addScreenCaptureFromPath(path);
